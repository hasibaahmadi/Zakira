...
<body class="login-page" id="body">
	...
	?>
				...
				<h3 style= "marging-Buttom:20px; text-align:center; borde-bottom:1px sold #ddd;font-weight: bold;"></h3>
				<?php echo form_open('Welcome/check_login')?>                       
					
						<div class="form-group">
							<input type="text" placeholder="username" class="form-control" style="font-size: 21px;" name="username" >
						</div> 
						<div class="form-group">
						...
						<div class="form-group form-action">
							<button class="btn btn-primary btn-block" style="font-size: 22px; font-weight: bold;"name="submit">login</button>
		                <?php form_close();?>

						
							<button class="btn btn-primary btn-block" style="font-size: 22px; font-weight: bold;"name="submit" value="submit"><?php echo anchor('admins/regiester','sign')?></button>
